...
def enter():
    global jumper, launchers,launchers2, background,data,data2
    ...
    for i in range(len(data2)):
        launchers2.append(Launcher2(random.randint(0,1000),data2[i]))
...
def update(frame_time):
    global image, current_time
    global jumper, launchers,launcers2, score
...
def draw(frame_time):
    ...
    global jumper, launchers, background, ui, launchers2
    ...
    if jumper.score>50:
        font.draw(430,100,"score 50 over !", (255,255,255))
    if jumper.score>100:
        font.draw(430,120,"score 100 over !", (255,255,255))
    if jumper.score>200:
        font.draw(430,140,"score 200 over !", (255,255,255))
    if jumper.score>500:
        font.draw(430,160,"score 500 over !", (255,255,255))
    if jumper.score>1000:
        font.draw(430,180,"score 1000 over !", (255,255,255))
    if jumper.score>2000:
        font.draw(430,200,"score 2000 over !", (255,255,255))
    if jumper.score>5000:
        font.draw(430,210,"score 5000 over !", (255,255,255))
    if jumper.score>10000:
        font.draw(430,230,"score 10000 over !", (255,255,255))
    if jumper.score>20000:
        font.draw(430,250,"score 20000 over !", (255,255,255))
...
class Launcher2:
    ...
    Earthquake2=160
    def __init__(self,x,y):
        self.image = load_image('jump.png')
        self.x,self.y=x,y
        self.state=self.BASIC
        self.time = 0
    def draw(self):
...
def gameover() :
    global jumper
    if jumper.die == True : game_framework.change_state(game_over)
